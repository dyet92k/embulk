...
/**
 * Represents a series of file-like inputs from Embulk's File Input Plugins.
 */
public interface FileInput extends AutoCloseable {
    /**
     * Returns {@code true} if this {@link org.embulk.spi.FileInput} has another file.
     *
     * @return {@code true} if this {@link org.embulk.spi.FileInput} has another file
     */
    boolean nextFile();

    /**
     * Reads actual data from this {@link org.embulk.spi.FileInput} into {@code Buffer}.
     *
     * @return the {@code Buffer} read
     */
    Buffer poll();
